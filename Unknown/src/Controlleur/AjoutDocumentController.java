...
import static Controlleur.NewFXMain1.main;
...
NewFXMain1 main=new NewFXMain1();
     ...
     Path from = Paths.get(f.toURI());
        Path to = Paths.get("C:/xampp/htdocs/Pidev/web/uploads/brochures/"+uuu+".jpeg");
