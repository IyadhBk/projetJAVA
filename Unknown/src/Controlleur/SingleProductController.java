...
import Controlleur.CommentController;
import Controlleur.AjoutCommentController;
   ...
   @FXML
    ...
    try {
       rating.addEventHandler(MouseEvent.MOUSE_CLICKED,(MouseEvent e)->{
        ...
        FXMLLoader x = new FXMLLoader(getClass().getResource("/GUI/comment.fxml"));
        Node pane = x.load();
    ...
    public void listeCommentaire() throws SQLException{
     ...
     this.PrixP.setText(String.valueOf(nvP)+" DT");
        ...
        for (Commentaire com : le) {
         ...
         File file = new File("C:/xampp/htdocs/Pidev/web/uploads/brochures/"+main.p.getBrochure());
...
this.imageP.setImage(i);
  ...
  loader.setLocation(AjoutCommentController.class.getResource("/GUI/AjoutComment.fxml"));
