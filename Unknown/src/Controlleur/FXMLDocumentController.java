...
import Controlleur.VboxViewController;
...
//    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
       NewFXMain1 main= new NewFXMain1();
            ...
            btnVend.setVisible(false);
             ...
             services.ServiceProduit Sc = new ServiceProduit();
        ...
        for (Produit p : le) {
                ...
                try {
                    FXMLLoader x = new FXMLLoader(getClass().getResource("/GUI/VboxView.fxml"));
                    Node pane = x.load();
 ...
 try {
              Parent home_page_parent = FXMLLoader.load(getClass().getResource("/GUI/GProduit.fxml"));
