...
public class MenuController {
    ...
    public void GestionMenu(MouseEvent event)
    {
        ...
        switch (dest) {
            ...
            case "veterinaires":
            case "vete":
                destination="afficherArticle.fxml";
                break;
            case "espace":
                destination="AssociationetToilitages.fxml";
                break;
            case "enc":
            case "ench":
                destination="AffichageAccueil.fxml";
                break;
            case "acceuil":
            ...
            case "ser":
                ...
                break;
            case "produits":
                destination="FXMLDocument.fxml";
                break;
            case "evenements":
            case "even":
            case "eve":
                destination="Front.fxml";
                break;
            case "pan":
            case "pani":
                destination="zanimaux.fxml";
                break;
            case "stor":
            case "sto":
